...
1. Pick representative `.xy` inputs (already in repo):
   ...
   | Source file | Why |
   | --- | --- |
   | `preset-probes/2026-06-app-required/a1-t1-p9.xy` | 9 drum presets, multi-pattern |
   | `preset-probes/2026-06-phase-b/b1-t1eng3bar1.xy` | Non-drum preset fragment |
   | `drum-sample-probes/2026-06-sample-paths/c1-pad01-lowf-v23-chi-box.xy` | Family C drum path |
   | `drum-sample-probes/archive-round0-nt-z-fx/c0-pad01-….xy` | Family B path |
...
| File | Source `.xy` |
| --- | --- |
| `a1-t1-p9.expected.json` | `preset-probes/2026-06-app-required/a1-t1-p9.xy` |
| `b1-t1eng3bar1.expected.json` | `preset-probes/2026-06-phase-b/b1-t1eng3bar1.xy` |
| `c1-pad01-lowf-v23-chi-box.expected.json` | `drum-sample-probes/2026-06-sample-paths/c1-pad01-lowf-v23-chi-box.xy` |
| `c0-pad01-nt-z-fx.expected.json` | `drum-sample-probes/archive-round0-nt-z-fx/c0-pad01-….xy` |
